...
- 30 min instructor: slides 1 to 3, then for each feature the problem, concept, demo (about 8 min each), and leadership card. Feature 04 first, then 05, then 06.
...
## 4. 04 · Semantic Search: The User Problem
...
## 10. 05 · Chunking Is a Correctness Decision
...
## 14. 06 · Recommendations: The User Problem
