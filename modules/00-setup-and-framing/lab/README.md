...
## 2. Local embeddings (powers Block 2 and anomaly detection)
...
All three passed: you're fully provisioned for all ten modules. Stretch goal: open [`data/`](../../../data/) and skim one trip report from `trip-reports/` end to end, granola recipes and all. Module 1 exists because nobody wants to read forty of those.
