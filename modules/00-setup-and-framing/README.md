...
- Four blocks: **Understanding**, **Finding**, **Deciding**, **Doing**. Three 30-minute modules per block, plus a double-length agent capstone.
- Every module has the same beat: 2 minutes on the user problem, a 13-minute live demo in .NET, a 13-minute lab you can do in any language, and 2 minutes on the leadership angle.
...
All ten modules work through **Trailhead Guides**, a fictional national-park trip-planning app with a deliberately messy corpus in [`data/`](../../data/): rambling trip reports, opinionated gear reviews, hundreds of trail descriptions, dry park regulations, and a queue of visitor inquiries. Each module stands alone, but they all live in the same park, so by mid-afternoon you'll know this data well enough to focus on the feature instead of the dataset.
