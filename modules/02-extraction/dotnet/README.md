# .NET demo for 02 Extraction (to be built)
...
Both will run with `dotnet run` against Ollama (`llama3.2`, JSON mode), matching the demo outline in [../README.md](../README.md).
