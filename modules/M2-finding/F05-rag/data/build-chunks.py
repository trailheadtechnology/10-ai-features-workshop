"""Rebuild chunks.jsonl from park-docs/ (next to this script).

You do not need to run this for the lab; chunks.jsonl ships ready to use. It is
here because chunking is the decision that quietly broke this feature, and a lab
...
The strategy, and why each part exists:
  ...
  document. That forward pointer is the fix for the bug this feature documents:
...
SRC = os.path.join(HERE, "park-docs")
