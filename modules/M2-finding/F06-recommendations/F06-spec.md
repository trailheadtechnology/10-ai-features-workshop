...
*A Challenge lab. Do it if you finished [Module 2](../M2-overview.md)'s Core lab and want another, or skip it without guilt: you will have seen this feature demonstrated either way.*
...
- **How:** Ollama embeddings via `lab/ollama.http` (only if computing fresh), then your own cosine-similarity ranking from feature 04.
- **Steps:**
