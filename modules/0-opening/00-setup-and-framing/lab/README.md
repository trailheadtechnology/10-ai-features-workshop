...
All three passed: you're fully provisioned for all ten features. Stretch goal: open [`data/`](../../../../data/) and skim one trip report from `trip-reports/` end to end, granola recipes and all. Feature 01 exists because nobody wants to read forty of those.
