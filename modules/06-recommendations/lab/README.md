...
- `trail-embeddings.json`: all 30 vectors, precomputed with `nomic-embed-text`, keyed by trail id (768 floats each). Reuse your module 04 vectors if you have them; this file is here so you can start cold.
