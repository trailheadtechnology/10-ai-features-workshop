...
**Triage and judgment.** About 75 minutes, split by the 3:00 coffee break, which lands in the middle of the lab.
...
The first 30 minutes or so are mine: the theme, and a demo of all three features. The next 40 are yours to build. 07 is the Recommended start, and after that you pick.
